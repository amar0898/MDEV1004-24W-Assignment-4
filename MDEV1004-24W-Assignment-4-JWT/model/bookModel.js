...
async function syncModelWithCloud() {
    ...
    if (existingData.length === undefined) {
      ...
      await BookModel.create([
        ...
        { BooksName: '1984', ISBN: '9780451524935', Rating: 4.18, Author: 'George Orwell', Genre: 'Classics' },

        { BooksName: 'The Great Gatsby', ISBN: '9780743273565', Rating: 3.91, Author: 'F. Scott Fitzgerald', Genre: 'Classics' },

        { BooksName: 'The Catcher in the Rye', ISBN: '9780316769174', Rating: 3.80, Author: 'J.D. Salinger', Genre: 'Classics' },

        { BooksName: 'To Kill a Kingdom', ISBN: '9781250112682', Rating: 3.96, Author: 'Alexandra Christo', Genre: 'Fantasy' },

        { BooksName: 'The Hunger Games', ISBN: '9780439023481', Rating: 4.32, Author: 'Suzanne Collins', Genre: 'Young Adult' },

        { BooksName: 'The Alchemist', ISBN: '9780061122415', Rating: 3.86, Author: 'Paulo Coelho', Genre: 'Fiction' },

        { BooksName: 'Harry Potter and the Sorcerer Stone', ISBN: '9780590353427', Rating: 4.47, Author: 'J.K. Rowling', Genre: 'Fantasy' },

        { BooksName: 'The Da Vinci Code', ISBN: '9780307474278', Rating: 3.81, Author: 'Dan Brown', Genre: 'Mystery' },

        { BooksName: 'The Hobbit', ISBN: '9780345534835', Rating: 4.27, Author: 'J.R.R. Tolkien', Genre: 'Fantasy' }
